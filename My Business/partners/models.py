...
class Partner(models.Model):
    ...
    partner_id = models.CharField(
        max_length=3, unique=True, error_messages={"unique": "This Partner ID is already in use."}
    )
    ...
    state = models.CharField(max_length=32, help_text="Should use 2 letter abbreviations for U.S. states")
    ...
    def get_pretty_contact_phone(self):
        ...
        elif (len(self.contact_phone) == 12 or len(self.contact_phone) == 13) and self.contact_phone[0] == "+":
    ...
    def get_statistics(self):
        ...
        # The number of non-void invoices
        statistics["non_void_invoices_count"] = self.invoices.exclude(status=4).count()
