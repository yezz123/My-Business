...
; (function ($) {
    ...
    $.fn.formset.defaults = {
        ...
        addText: '<i class="fas fa-plus fa-fw"></i> Add item',          // Text for the add link
        deleteText: '<i class="fas fa-trash fa-fw"></i>',            // Text for the delete link
        addContainerClass: null,         // Container CSS class for the add link
        deleteContainerClass: "btn-delete-container",      // Container CSS class for the delete link
        addCssClass: 'btn btn-sm btn-success',          // CSS class applied to the add link
        deleteCssClass: 'btn btn-sm btn-danger',    // CSS class applied to the delete link
